...
//        Stats stats = userDao.getUserStatsById(USER.getId()).orElseThrow(UserNotFoundException::new);
//        assertNotNull(stats);
//        assertEquals(stats.getJobsCount(), USER_STATS.getJobsCount());
//        assertEquals(stats.getAvgRating(), USER_STATS.getAvgRating());
//        assertEquals(stats.getReviewCount(), USER_STATS.getReviewCount());
//    }
//
//
//    @Test
...
//        Location location = userDao.getLocationByProviderId(1L);
//        City[] cities = location.getCities().toArray(new City[0]);
//        for (int i = 0; i < 3; i++) {
//            assertEquals(cities[i].getId(), i + 1);
//        }
//        assertEquals(3, cities.length);
//
//        location = userDao.getLocationByProviderId(99L);
//        assertNull(location);
//
//    }
//
...
//        Schedule schedule = userDao.getScheduleByUserId(1L).orElseThrow(UserNotFoundException::new);
//        assertEquals(schedule.getStartTime(), "11:00");
//        assertEquals(schedule.getEndTime(), "18:00");
//    }
//
//    @Test
