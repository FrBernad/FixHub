...
<form:form modelAttribute="contactForm" id="contactForm" action="${postPath}" class="contactForm" method="POST">
    ...
    <div class="row">
        <div class="col">
            <div class="form-group">
                <form:label path="state"><spring:message code="contactForm.state"/> <span class="required-field">*</span></form:label>
        ...
        <div class="col">
            <div class="form-group">
                <form:label path="city"><spring:message code="contactForm.city"/> <span class="required-field">*</span></form:label>
    ...
    <div class="form-group">
        <form:label path="street"><spring:message code="contactForm.street"/> <span class="required-field">*</span></form:label>
    ...
    <div class="row">
        <div class="col-4">
            <div class="form-group">
                <form:label path="addressNumber"><spring:message code="contactForm.addressNumber"/> <span class="required-field">*</span></form:label>
    ...
    <div class="form-group">
        <form:label path="message"><spring:message code="contactForm.description"/> <span class="required-field">*</span></form:label>
