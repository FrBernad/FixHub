                            ...
                            <div class="row">
                                ...
                                <div class="col-12 px-0">
                                    <div class="form-group d-flex justify-content-between align-items-center">
                                        ...
                                        <button class="buttonCustom d-flex align-items-center justify-content-center" type="button" id="addFileButton">
